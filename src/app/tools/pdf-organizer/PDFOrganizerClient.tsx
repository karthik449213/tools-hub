        ...
        <CardContent>
          <div className="text-center">
            <input
              ...
              className="hidden"
            />
            <Button onClick={() => fileInputRef.current?.click()} className="mb-4" disabled={isProcessing}>
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {pages.map((page, index) => (
                <DraggablePage key={page.index} page={page} index={index} onReorder={handleReorder} />
              ))}
            </div>

            <div className="mt-6 text-center">
              <Button onClick={handleDownload} disabled={isReordering} size="lg">
